        ...
        <Bottom>
          ...
          <Summary>
            ...
            <SummaryItem type="total">
              <SummaryItemText>Total</SummaryItemText>
              <SummaryItemPrice>R$ {cart.total + 5.90}</SummaryItemPrice>
            </SummaryItem>
            <StripeCheckout
              name="Bosque Panetteria"
              image=""
              billingAddress="Endereço do pedido"
              shippingAddress="Endereço de entrega"
              description={`Seu total é R$${cart.total + 5.90}`}
              amount={cart.total * 100 + 590}
              token={onToken}
              stripeKey={KEY}
            >
